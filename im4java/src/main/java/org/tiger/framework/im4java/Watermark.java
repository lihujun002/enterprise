...
public class Watermark {
	 ...
	 * @throws IM4JavaException
	 */
	private static synchronized void watermarkImg(String srcPath, String distPath, String watermarkImg, int width,
			int height, int x, int y, int alpha) throws IOException, InterruptedException, IM4JavaException {
		CompositeCmd cmd = (CompositeCmd)ImageCommandFactory.getImageCommand("composite");
	 ...
	 * @throws IOException
	 */
	public final static void drawWatermark(String shopName, String watermarkImg, Integer fontSize, String color)
			throws IOException {
		...
		ImageIO.write(image, "png", new File(watermarkImg));
	}
	 ...
	 */
	@Deprecated
	public static void converFontToImage(String text, String fontType, int fontSize, String colorStr, String outfile)
			throws Exception {
